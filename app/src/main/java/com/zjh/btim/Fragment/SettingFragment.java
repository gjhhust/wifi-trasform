...
import com.zjh.btim.Receiver.FileReceiverActivity;
import com.zjh.btim.Util.BluetoothUtil;
import com.zjh.btim.Util.PermissionUtil;
import com.zjh.btim.sender.FileSenderActivity;
import com.zjh.btim.textmessage.Bootloader;
...
public class SettingFragment extends Fragment implements View.OnClickListener {
    ...
    private CardView cv_file_send;
    private CardView cv_file_recive;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        cv_wifi = view.findViewById(R.id.cv_wifi);
        cv_wifi.setOnClickListener(this);

        cv_file_send = view.findViewById(R.id.cv_file_send);
        cv_file_send.setOnClickListener(this);
        cv_file_recive = view.findViewById(R.id.cv_file_recive);
        cv_file_recive.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.cv_bt_qx_setting:
                ...
                break;
            case R.id.cv_wifi:
                Intent intent2 = new Intent(getContext(), Bootloader.class);
                startActivity(intent2);
                break;
            case R.id.cv_file_send:
                Intent intent3 = new Intent(getContext(), FileSenderActivity.class);
                startActivity(intent3);
                break;
            case R.id.cv_file_recive:
                Intent intent4 = new Intent(getContext(), FileReceiverActivity.class);
